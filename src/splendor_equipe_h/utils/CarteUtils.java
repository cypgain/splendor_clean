...
public class CarteUtils
{
    ...
    public static ArrayList<Carte> getDeckTwo()
    {
        ArrayList<Carte> deckTwo = new ArrayList<Carte>()
        {
            ...
            add(new Carte("../ressources/dev_II_06.png", 3, Couleur.BLANC, 0, 6, 0, 0, 0));
            ...
            add(new Carte("../ressources/dev_II_12.png", 3, Couleur.BLEU, 0, 0, 6, 0, 0));
            ...
            add(new Carte("../ressources/dev_II_18.png", 3, Couleur.VERT, 6, 0, 0, 0, 0));
            ...
            add(new Carte("../ressources/dev_II_24.png", 3, Couleur.ROUGE, 0, 0, 0, 0, 6));
            ...
            add(new Carte("../ressources/dev_II_30.png", 3, Couleur.MARRON, 0, 0, 0, 6, 0));
        }};
